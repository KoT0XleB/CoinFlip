...
namespace CoinFlip
{
    public class CoinFlip : Plugin
    {
        ...
        public void RegisterEvents()
        {
            ...
            if (CustomConfig.TeleportEnable) Qurre.Events.Player.CoinFlip += OnCoinFlip;
            if (CustomConfig.FlipMessageEnable) Qurre.Events.Player.PickupItem += OnCoinPickup;
        }
        ...
        public void OnCoinFlip(CoinFlipEvent ev)
        {
            Timing.CallDelayed(CustomConfig.Delay, () =>
            {
                ...
                {
                    if (Qurre.API.Controllers.Alpha.Detonated == false)
                    {
                ...
                ev.Player.ShowHint(CustomConfig.Result + CustomConfig.FirstCoin, CustomConfig.DelayBroadcast);
            });
        }
